...
This module contains the implementation of a GCN-based encoder for converting
...
class GCNEncoder(BaseGNNEncoder):
    ...
    This encoder uses multiple GCN layers to process node features,
