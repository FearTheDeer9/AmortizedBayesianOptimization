...
class RandomValueAcquisitionStrategy(ValueAcquisitionStrategy):
    def __init__(self, nodes, args):
        super().__init__(nodes=nodes, args=args)
...
class GridValueAcquisitionStrategy(ValueAcquisitionStrategy):
    def __init__(self, nodes, args):
        super().__init__(nodes=nodes, args=args)
        self.intervention_value_prior = (
            lambda size: np.array(args.intervention_values * args.num_nodes)
            .reshape(args.num_nodes, len(args.intervention_values))
            .T
        )
