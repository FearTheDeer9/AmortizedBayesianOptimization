...
class BASE:
    ...
    def chosen_structure(self) -> GraphStructure:
        ...
        Simplified for PARENT_SCALE integration - graph should be passed directly
        """
        # For PARENT_SCALE integration, we'll pass the graph directly in __init__
        # This method can be simplified or overridden in subclasses
        return self.graph
