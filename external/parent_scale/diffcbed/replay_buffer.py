"""
ReplayBuffer implementation matching original diffcbed buffer for PARENT_SCALE integration.
"""
import numpy as np
...
class ReplayBuffer(object):
    """ReplayBuffer matching original diffcbed implementation."""
    ...
    def update(self, data):
        ...
        Args:
            data: Object with .samples and .intervention_node attributes
        """
    ...
    def data(self):
        """Return buffered data in Data namedtuple format."""
        interventions = []
        samples = []
