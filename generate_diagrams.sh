#!/bin/bash
# All-in-one script to generate thesis-quality architecture diagrams

echo "================================================"
echo "MSc Thesis Architecture Diagram Generator"
echo "================================================"

# Step 1: Install required packages
echo ""
echo "Step 1: Installing required packages..."
pip install torch torchview torchviz graphviz torchinfo matplotlib

# Also install Graphviz binary if on Mac
if [[ "$OSTYPE" == "darwin"* ]]; then
    if ! command -v dot &> /dev/null; then
        echo "Installing Graphviz binary (Mac)..."
...
echo ""
echo "Step 2: Creating diagram generation script..."

cat > generate_thesis_diagrams.py << 'EOF'
"""
...
echo ""
echo "================================================"
echo "Complete! Your thesis diagrams are ready."
echo "================================================"
echo ""
echo "Generated files in 'thesis_diagrams/' folder:"
echo "  - architecture.png : Main architecture diagram"
echo "  - custom_diagram.png : Clean block diagram"
echo "  - model_summary.txt : Parameter counts"
echo ""
echo "To use in your thesis:"
echo "1. Insert the PNG files as figures"
echo "2. Use captions like: 'Figure X: Architecture of the Continuous Parent Set Prediction Model'"
echo "3. Reference the model summary for parameter counts"