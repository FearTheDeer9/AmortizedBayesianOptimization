...
python3 graph6_script.py --seeds_replicate 619 --n_observational 200 --n_trials 50 --n_anchor_points 35 --run_num 9 --noiseless
python3 graph6_script.py --seeds_replicate 77 --n_observational 200 --n_trials 50 --n_anchor_points 35 --run_num 10 --noiseless
