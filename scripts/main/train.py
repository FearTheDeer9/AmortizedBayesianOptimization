...
def train_bc(config: DictConfig) -> Dict[str, Any]:
    ...
    policy_architecture = config.get('policy_architecture', 'alternating_attention')
...
def main():
    ...
    config = DictConfig({
        ...
        'policy_architecture': args.architecture or 'alternating_attention',  # Policy architecture selection with default
    ...
    logger.info(f"  Architecture: {args.architecture or 'alternating_attention (default)'}")
