python3 graph5_script_blanket.py --seeds_replicate 17 --n_observational 200 --n_trials 50 --n_anchor_points 35 --run_num 1 --noiseless
python3 graph5_script_blanket.py --seeds_replicate 87 --n_observational 200 --n_trials 50 --n_anchor_points 35 --run_num 2 --noiseless
python3 graph5_script_blanket.py --seeds_replicate 89 --n_observational 200 --n_trials 50 --n_anchor_points 35 --run_num 3 --noiseless
python3 graph5_script_blanket.py --seeds_replicate 69 --n_observational 200 --n_trials 50 --n_anchor_points 35 --run_num 4 --noiseless
