...
- Consistent ordering (alphabetical by default)
...
class VariableMapper:
    ...
    def __init__(self, variables: List[str], target_variable: Optional[str] = None):
        ...
        Args:
            variables: List of variable names (will be sorted alphabetically)
        ...
        # Store sorted variable order (single source of truth)
